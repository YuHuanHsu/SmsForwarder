...
import com.idormy.sms.forwarder.core.XPageTransferActivity;
...
public class XRouter$$Group$$xpage implements IRouteGroup {
  ...
  public void loadInto(Map<String, RouteInfo> routeInfos) {
    routeInfos.put("/xpage/transfer", RouteInfo.build(RouteType.ACTIVITY, XPageTransferActivity.class, "/xpage/transfer", "xpage", new java.util.HashMap<String, Integer>(){{put("pageName", 10); }}, -1, -2147483648));
  }
}
