 ...
 */
public final class SmsControllerSendHandler extends MappingHandler {
  private Object mHost;

  public SmsControllerSendHandler(Object host, Mapping mapping, Addition addition,
  ...
  protected View onHandle(HttpRequest request, HttpResponse response) throws Throwable {
    ...
    BaseRequest<SmsSendData> body0 = null;
    if (converter != null && requestBody != null) {
      Type body0Type = new TypeWrapper<BaseRequest<SmsSendData>>(){}.getType();
    ...
    Object o = ((SmsController)mHost).send(body0);
