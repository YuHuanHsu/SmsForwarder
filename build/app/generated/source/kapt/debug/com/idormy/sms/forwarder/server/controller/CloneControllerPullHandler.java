 ...
 */
public final class CloneControllerPullHandler extends MappingHandler {
  private Object mHost;

  public CloneControllerPullHandler(Object host, Mapping mapping, Addition addition,
  ...
  protected View onHandle(HttpRequest request, HttpResponse response) throws Throwable {
    ...
    BaseRequest<CloneInfo> body0 = null;
    if (converter != null && requestBody != null) {
      Type body0Type = new TypeWrapper<BaseRequest<CloneInfo>>(){}.getType();
    ...
    Object o = ((CloneController)mHost).pull(body0);
