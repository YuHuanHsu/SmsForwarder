 ...
 */
public final class SmsControllerQueryHandler extends MappingHandler {
  private Object mHost;

  public SmsControllerQueryHandler(Object host, Mapping mapping, Addition addition,
  ...
  protected View onHandle(HttpRequest request, HttpResponse response) throws Throwable {
    ...
    BaseRequest<SmsQueryData> body0 = null;
    if (converter != null && requestBody != null) {
      Type body0Type = new TypeWrapper<BaseRequest<SmsQueryData>>(){}.getType();
    ...
    Object o = ((SmsController)mHost).query(body0);
