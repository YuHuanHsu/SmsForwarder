...
public final class ContactControllerQueryHandler extends MappingHandler {
  ...
  public ContactControllerQueryHandler(Object host, Mapping mapping, Addition addition,
  ...
  protected View onHandle(HttpRequest request, HttpResponse response) throws Throwable {
    ...
    BaseRequest<ContactQueryData> body0 = null;
    if (converter != null && requestBody != null) {
      Type body0Type = new TypeWrapper<BaseRequest<ContactQueryData>>(){}.getType();
    ...
    Object o = ((ContactController)mHost).query(body0);
