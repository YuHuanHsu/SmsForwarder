 ...
 */
public final class ContactControllerAdapter extends MappingAdapter {
  private ContactController mHost;

  private Map<Mapping, RequestHandler> mMappingMap;

  public ContactControllerAdapter() {
    this.mHost = new ContactController();
    this.mMappingMap = new LinkedHashMap<>();

     {
      ...
      ContactControllerQueryHandler handler = new ContactControllerQueryHandler(mHost, mapping, addition, crossOrigin);
...

     {
      ...
      crossOrigin.setAllowCredentials(true);
      crossOrigin.setMaxAge(1800);
      ContactControllerAddHandler handler = new ContactControllerAddHandler(mHost, mapping, addition, crossOrigin);
      mMappingMap.put(mapping, handler);
    }
  }
  ...
  @Override
  protected ContactController getHost() {
    return mHost;
  }
}
