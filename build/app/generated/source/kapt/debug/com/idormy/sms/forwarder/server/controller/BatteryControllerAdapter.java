 ...
 */
public final class BatteryControllerAdapter extends MappingAdapter {
  private BatteryController mHost;

  private Map<Mapping, RequestHandler> mMappingMap;

  public BatteryControllerAdapter() {
    this.mHost = new BatteryController();
    this.mMappingMap = new LinkedHashMap<>();

     {
      ...
      BatteryControllerQueryHandler handler = new BatteryControllerQueryHandler(mHost, mapping, addition, crossOrigin);
  ...
  @Override
  protected BatteryController getHost() {
    return mHost;
  }
}
