 ...
 */
public final class CallControllerAdapter extends MappingAdapter {
  private CallController mHost;

  private Map<Mapping, RequestHandler> mMappingMap;

  public CallControllerAdapter() {
    this.mHost = new CallController();
    this.mMappingMap = new LinkedHashMap<>();

     {
      ...
      CallControllerQueryHandler handler = new CallControllerQueryHandler(mHost, mapping, addition, crossOrigin);
  ...
  @Override
  protected CallController getHost() {
    return mHost;
  }
}
