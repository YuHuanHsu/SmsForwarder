 ...
 */
public final class WolControllerSendHandler extends MappingHandler {
  private Object mHost;

  public WolControllerSendHandler(Object host, Mapping mapping, Addition addition,
  ...
  protected View onHandle(HttpRequest request, HttpResponse response) throws Throwable {
    ...
    BaseRequest<WolData> body0 = null;
    if (converter != null && requestBody != null) {
      Type body0Type = new TypeWrapper<BaseRequest<WolData>>(){}.getType();
    ...
    Object o = ((WolController)mHost).send(body0);
