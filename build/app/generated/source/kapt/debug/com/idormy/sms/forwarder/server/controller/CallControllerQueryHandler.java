 ...
 */
public final class CallControllerQueryHandler extends MappingHandler {
  private Object mHost;

  public CallControllerQueryHandler(Object host, Mapping mapping, Addition addition,
  ...
  protected View onHandle(HttpRequest request, HttpResponse response) throws Throwable {
    ...
    BaseRequest<CallQueryData> body0 = null;
    if (converter != null && requestBody != null) {
      Type body0Type = new TypeWrapper<BaseRequest<CallQueryData>>(){}.getType();
    ...
    Object o = ((CallController)mHost).query(body0);
