 ...
 */
public final class LocationControllerQueryHandler extends MappingHandler {
  private Object mHost;

  public LocationControllerQueryHandler(Object host, Mapping mapping, Addition addition,
  ...
  protected View onHandle(HttpRequest request, HttpResponse response) throws Throwable {
    ...
    BaseRequest<EmptyData> body0 = null;
    if (converter != null && requestBody != null) {
      Type body0Type = new TypeWrapper<BaseRequest<EmptyData>>(){}.getType();
    ...
    Object o = ((LocationController)mHost).query(body0);
