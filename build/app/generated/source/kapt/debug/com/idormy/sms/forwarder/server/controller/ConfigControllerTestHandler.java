 ...
 */
public final class ConfigControllerTestHandler extends MappingHandler {
  private Object mHost;

  public ConfigControllerTestHandler(Object host, Mapping mapping, Addition addition,
  ...
  protected View onHandle(HttpRequest request, HttpResponse response) throws Throwable {
    ...
    BaseRequest<?> body0 = null;
    if (converter != null && requestBody != null) {
      Type body0Type = new TypeWrapper<BaseRequest<?>>(){}.getType();
    ...
    Object o = ((ConfigController)mHost).test(body0);
