...
public final class AdapterTaskListItemBinding implements ViewBinding {
  @NonNull
  ...
  private AdapterTaskListItemBinding(@NonNull LinearLayout rootView, @NonNull ImageView ivDrag,
  ...
  @NonNull
  public static AdapterTaskListItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static AdapterTaskListItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.adapter_task_list_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static AdapterTaskListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AdapterTaskListItemBinding((LinearLayout) rootView, ivDrag, ivEdit, ivImage,
