...
public final class FragmentRulesBinding implements ViewBinding {
  ...
  private FragmentRulesBinding(@NonNull LinearLayout rootView, @NonNull RecyclerView recyclerView,
  ...
  public static FragmentRulesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentRulesBinding((LinearLayout) rootView, recyclerView, refreshLayout, tabBar);
    }
