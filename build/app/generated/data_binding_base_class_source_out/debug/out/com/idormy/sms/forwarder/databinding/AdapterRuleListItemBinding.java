...
public final class AdapterRuleListItemBinding implements ViewBinding {
  @NonNull
  ...
  private AdapterRuleListItemBinding(@NonNull LinearLayout rootView, @NonNull ImageView ivDrag,
  ...
  @NonNull
  public static AdapterRuleListItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static AdapterRuleListItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.adapter_rule_list_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static AdapterRuleListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AdapterRuleListItemBinding((LinearLayout) rootView, ivDrag, ivEdit, ivImage,
