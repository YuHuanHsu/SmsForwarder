...
public final class AdapterFrpcListItemBinding implements ViewBinding {
  @NonNull
  ...
  private AdapterFrpcListItemBinding(@NonNull LinearLayout rootView, @NonNull ImageView ivDrag,
  ...
  @NonNull
  public static AdapterFrpcListItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static AdapterFrpcListItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.adapter_frpc_list_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static AdapterFrpcListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AdapterFrpcListItemBinding((LinearLayout) rootView, ivDrag, ivEdit, ivImage,
