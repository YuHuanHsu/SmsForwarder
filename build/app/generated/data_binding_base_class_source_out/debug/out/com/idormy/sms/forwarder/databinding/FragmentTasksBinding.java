...
public final class FragmentTasksBinding implements ViewBinding {
  ...
  private FragmentTasksBinding(@NonNull LinearLayout rootView, @NonNull RecyclerView recyclerView,
  ...
  public static FragmentTasksBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentTasksBinding((LinearLayout) rootView, recyclerView, refreshLayout, tabBar);
    }
